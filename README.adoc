...
* Checkmarx Query Engine: Evaluates source code against security rules and vulnerability patterns.
...
NOTE: For more information about Checkmarx One SAST, refer to the link:https://checkmarx.com/product/application-security-platform/[Checkmarx One documentation].
...
| String
| No
| CloudBees API URL. Default: `https://api.cloudbees.io`
...
* Learn about link:https://checkmarx.com/product/application-security-platform/[Checkmarx One SAST].
