...
NOTE: For more information about Checkmarx One SAST, refer to the link:https://docs.checkmarx.com/en/34965-324470-sast-scanner.html[Checkmarx One SAST Documentation].
...
The following GHA workflow example scans code and filters results to show only critical and high severity findings.
...
jobs:
  checkmarxone-sast-filtered-scan:
    runs-on: ubuntu-latest
    steps:
      - name: Check out source code
        uses: actions/checkout@v4
